...
abstract class _BookingDataSource ***REMOVED***
  Future<Either<AppError, List<BookingModel>>> getBookingOnDate(***REMOVED***required String date, required String serviceId***REMOVED***);
  Future<Either<AppError, List<BookingModel>>> makeBooking(***REMOVED***required List<BookingModel> booking***REMOVED***);

  Future<Either<AppError, List<BookingModel>>> getUserBookings();

  Future<Either<AppError, List<BookingModel>>> getMerchantBookings();
  Future<Either<AppError, bool>> updateBookings(***REMOVED***required String bookingId, required OrderType orderType***REMOVED***);
***REMOVED***
...
class BookingDataSource implements _BookingDataSource ***REMOVED***
  ...
  final Ref _ref;
***REMOVED***
  Future<Either<AppError, List<BookingModel>>> getBookingOnDate(***REMOVED***required String date, required String serviceId***REMOVED***) async ***REMOVED***
***REMOVED***
...
***REMOVED***
  Future<Either<AppError, List<BookingModel>>> makeBooking(***REMOVED***required List<BookingModel> booking***REMOVED***) async ***REMOVED***
***REMOVED***
...
***REMOVED***
  Future<Either<AppError, bool>> updateBookings(***REMOVED***required String bookingId, required OrderType orderType***REMOVED***) async ***REMOVED***
***REMOVED***
